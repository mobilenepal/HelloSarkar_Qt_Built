...
**
** Created: Sat Dec 3 02:25:29 2011
...
static const char qt_meta_stringdata_history[] = {
    "history\0\0updateRecord()\0delRecord()\0"
    "viewDetail()\0"
};

const QMetaObject history::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_history,
...
int history::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updateRecord(); break;
        case 1: delRecord(); break;
        case 2: viewDetail(); break;
        default: ;
        }
        _id -= 3;
    }
